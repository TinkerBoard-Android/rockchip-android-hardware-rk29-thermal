...
TemperatureThreshold kRockchipTempThreshold[TT_MAX] = {
	{
		.type = TemperatureType::CPU,
		.name = CPU_TZ_NAME,
		.hotThrottlingThresholds = {{NAN, NAN, NAN, 85, NAN, NAN, 105}},
	...
	},
	{
		...
		.name = GPU_TZ_NAME,
		.hotThrottlingThresholds = {{NAN, NAN, NAN, 85, NAN, NAN, NAN}},
		.coldThrottlingThresholds = {{NAN, NAN, NAN, NAN, NAN, NAN, NAN}},
		.vrThrottlingThreshold = 70,
	},
	{
